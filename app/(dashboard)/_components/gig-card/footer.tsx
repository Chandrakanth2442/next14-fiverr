...
export const Footer=({ isFavorite,
    title,
    ownerLabel,
    createdAtLabel,
    onClick,
    ...
    let averageReview: number=reviews.length>0? reviews.reduce((acc, review)=>
    acc + review.communication_level+review.recommend_to_a_friend + review.service_as_described, 0)/(reviews.length*3):0;
